...
const getLeadDetails = (id: string): LeadDetails => {
  return {
    ...
    notes: "Customer wants modern design with island. Prefers quartz countertops.",
    propertyDetails: {
      lawnType: "N/A",
      obstacles: "Load bearing wall needs inspection",
      slope: "Level",
      fencing: "N/A",
      pets: "1 dog",
      specialInstructions: "Please use side entrance. Security code: 1234",
    },
    documents: [
      {
        name: "Kitchen Layout",
    ...
    history: [
      {
        ...
        notes: "Discussed kitchen layout and preferences",
      },
      {
        date: "2024-01-12",
        action: "Quote Sent",
        notes: "Provided detailed estimate for kitchen remodel",
      },
      {
        date: "2024-01-13",
        action: "Quote Accepted",
        notes: "Customer approved the project scope and cost",
      },
    ],
    engagementMetrics: {
      totalServices: 1,
